...
4) Test with PPO:
    a. Stationary: `python scripts/01_train_ppo.py --env_id MiniGrid-Empty-8x8-v0 --total_timesteps 600000 --run_name baseline_stationary`
    b. Slow switch (~200k): `python scripts/01_train_ppo.py --env_id MiniGrid-Empty-8x8-v0 --total_timesteps 600000 --steps_per_regime 25000 --run_name exp_slow_switch`
    c. Fast switches (~40k): `python scripts/01_train_ppo.py --env_id MiniGrid-Empty-8x8-v0 --total_timesteps 600000 --steps_per_regime 5000 --run_name exp_fast_switch`
